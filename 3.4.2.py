...
class YearSalary:
    ...
    :param currency_to_rub: Таблица перевода из определенной валюты в рубли
    :type dict

    :param count_vacancies: Количество вакансий
    :type int
    """
...
class Statistic:
    ...
    def convert_to_param_salary(self, vacancies: List[Vacancy]) -> list:
        """
    ...
    def __convert_from_param_salary_to_dict(self, param_salary: List[YearSalary]) -> tuple:
        """
...
class InputConnect:
    ...
    :param input_data: Данные представленные пользователем (Запрос, имя файла, название нужной профессии)
