...
class ProcessSalaries:
    ...
    def process_salaries(self) -> None:
        """
        Обрабатывает зарплаты, переводя в рубли в соответствии с нужным курсом.
        Удаляет строки, в которых невозможно посчитать зарплату. Сохраняет в формате CSV.
        """
